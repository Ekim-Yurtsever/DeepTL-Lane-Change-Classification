...
filenames = ['dataset_InceptionResNetV2_5percent.pickle', 'dataset_resnet_features_5percent.pickle', 'dataset_NASNetLarge_5percent.pickle', 'dataset_mobilenet_v2.pickle']
...
models.train_n_fold_cross_val(Data, label, training_to_all_data_ratio=training_to_all_data_ratio, n=nb_cross_val,
                              ...
                              save_path="results/"+filename+".png")
